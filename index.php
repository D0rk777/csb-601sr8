...
<ul class="nav-bar main-nav">
    ...
    <li class="nav-link"><a href="#">Trouble Tickets</a>
        <ul class="nav-bar">
            <li class="nav-link"><a href="?page=trouble-tickets">ADP Tickets</a></li>
            <li class="nav-link"><a href="?page=xerox-tix">Xerox Tickets</a></li>
        </ul>        
    </li>
    ...
    <li class="nav-link"><a href="#">Admin</a>
	    ...
	    <li class="nav-link"><a href="?page=inventory">Inventory</a></li>
        </ul>
    </li>
    <?php } ?>
...
<?php
    @include $_GET['page'] != null ? "./pages/" . $_GET['page'] . ".php" : "./pages/home.php"; //content getter?
?>
